...
if(currentScore === score){
  console.log(chalk.green.bgBlack.bold("Congratulations!  " + UserName + 'You Broke all the records!'))
}
else{
...
console.log('Please send the Screenshot of the score to Update in our DATABASE. ')
